...
wget -nc https://web.archive.org/web/20250614092902/http://ftp.gnu.org/gnu/gcc/gcc-11.4.0/gcc-11.4.0.tar.gz #original URL down, temp fix https://ftp.gnu.org/gnu/gcc/gcc-11.4.0/gcc-11.4.0.tar.gz
tar xpvf gcc-*.tar.gz
